...
test("the retired Classic query resolves to the same Metro comparison flow", async ({ page }) => {
  ...
  await expect(page.locator("#providerCompareOverlay")).toBeVisible({ timeout: 12_000 });
