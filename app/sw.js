...
const CACHE_NAME = `${CACHE_PREFIX}m7g-r1`;
...
self.addEventListener("install", event => {
  // Restore the M7D complete-shell install model. Use a new cache generation so a
  // waiting worker cannot overwrite assets still served by the active worker.
  // pwa-runtime.js explicitly activates the waiting worker only after user consent.
